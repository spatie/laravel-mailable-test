...
[![GitHub Workflow Status](https://github.com/spatie/laravel-mailable-test/actions/workflows/run-tests.yml/badge.svg)](https://github.com/spatie/laravel-mailable-test/actions/workflows/run-tests.yml)
